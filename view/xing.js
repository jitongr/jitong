...
//            timer === .5 * this.n && (description.text = this.information);
    ...
    backgroundImage.src = "/content/templates/images/U803P2T95D3962F1501DT20140919162041.jpg";
    backshadowImage.src = "/content/templates/images/bgPoints.png";
    b2bImage.src = "/content/templates/images/icon0.png";
    xiaofeiImage.src = "/content/templates/images/icon10.png";
    saleImage.src = "/content/templates/images/icon20.png";
    o2oImage.src = "/content/templates/images/icon30.png";
    pointImage.src = "/content/templates/images/point.png";
