...
<div class="info2"><form method='post'><input style="width:400px;" value="<?php echo $value['img']==""?"/jty/":$value['img']; ?>"  name="img" /><input type="hidden" name="id" value="<?=$value['id']?>"><input  type='submit' value='提交'/></form><?=date('Y-m-d H:i:s',$value['edittime'])?> [<?php echo getcptype($value['sort']); ?>] <?php echo $value['birth'].'-'.$value['die']; ?><?php echo $value['age']; ?>
